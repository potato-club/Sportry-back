...
public class RegionController {
    ...
    @Operation(summary = "선택한 지역 불러오기")
    @GetMapping("/")
    public ResponseEntity<String> loadUserRegion(HttpServletRequest request) {
        String city = regionService.loadUserRegion(request);
